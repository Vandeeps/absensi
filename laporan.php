...
<h1 class="judul" align="center">Sistem Data Pegawai</h1>
  ...
  <div class="container-navbar">
    ...
    <li class="li-navbar">
      ...
      <li class="li-navbar">
        <a href="viewdatabarang.php" class="a-navbar">DATA PEGAWAI</a>
      </li>
      <li class="li-navbar">
      <a href="tambahdatabarang.php" class="a-navbar">TAMBAH DATA PEGAWAI</a>
      </li>
      <li class="li-navbar">
        <a href="pembelian.php" class="a-navbar">ABSENSI</a>
      </li>
      <li class="li-navbar">
        <a href="pembelian.php" class="a-navbar">ISI DAFTAR HADIR</a>
      </li>
      <li class="li-navbar">
